...
public class CollegeModel {
	...
	//Find by Primary Key By a College
	
	/**
	 * find record from databse with primarykey
	 * @param pk
	 * @return
	 * @throws ApplicationException
	 */
	...
	public List search(CollegeBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM ST_COLLEGE WHERE 2=2");
