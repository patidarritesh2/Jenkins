...
public class FacultyModel {
	...
	public long add(FacultyBean fb) throws Exception {
		...
		try {
			...
			ps.setInt(10, fb.getCollege_id());
			ps.setString(11, collegeName);
			ps.setInt(12, fb.getCourse_id());
			ps.setString(13, courseName);
			ps.setInt(14, fb.getSubject_id());
	...
	public FacultyBean findByEmail(String EmailId) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				fb.setSubject_Name(rs.getString(11));
				fb.setCollege_Name(rs.getString(12));
				fb.setCollege_Name(rs.getString(13));	
	...
	public FacultyBean findByPK(int pk) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
				...
				fb.setSubject_Name(rs.getString(9));
				fb.setCollege_id(rs.getInt(10));
				fb.setCollege_Name(rs.getString(11));
				fb.setCourse_id(rs.getInt(12));
				fb.setCourse_Name(rs.getString(13));
				fb.setSubject_id(rs.getInt(14));	
