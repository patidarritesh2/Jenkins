...
public class FacultyCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		try {
			List<CourseBean> courseList = course.list();
			List<CollegeBean> collegeList = college.list();
			List<SubjectBean> subjectList = subject.list();
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println(fb.getCollege_id() + " " + fb.getSubject_id() + " " + fb.getCourse_id());
